package nuc.edu.seckill.common.util;
...
public class EntityUtil {
    ...
    private final String moduleName = "miaosha"; // 数据库名称

    private final String bean_path = "E:\\javaWorkSpace\\seckill-parent\\seckill-service\\src\\main\\java";

    private final String mapper_path = "E:\\javaWorkSpace\\seckill-parent\\seckill-service\\src\\main\\java\\nuc\\edu\\seckill\\dao";

    private final String xml_path = "E:\\javaWorkSpace\\seckill-parent\\seckill-service\\src\\main\\resources\\mapping";// xml路径

    private final String model_package = "nuc.edu.seckill.model";// model的包所在

    private final String dao_package = "nuc.edu.seckill.dao";// dao的包所在
    ...
    private void buildMapper(List<String> columns, List<String> types) throws IOException {
        ...
        bw.newLine();
        bw.write("import nuc.edu.seckill.common.util.bean.CommonQueryBean;");
        bw.newLine();
        bw.newLine();
